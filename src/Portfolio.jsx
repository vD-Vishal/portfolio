...
export const portfolioData = {
  ...
  socials: { linkedin: 'https://www.linkedin.com/in/vishal-durga-dr-902369354/', github: 'https://github.com/vD-Vishal', scaler: 'https://www.scaler.com/academy/profile' },
  experience: [
    {
        "company": "GlobalLogic",
...
export default function Portfolio() {
  ...
  return <MotionConfig reducedMotion="user"><motion.div className="scroll-progress" style={{scaleX: progress}}/><a className="skip-link" href="#main">Skip to content</a>
    <div className="motion-background" aria-hidden="true"><span/><span/><span/></div>
